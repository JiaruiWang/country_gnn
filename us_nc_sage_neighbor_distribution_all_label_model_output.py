...
from us_lgc_all_label_51by6_neighbor_distribution_with_id_in_mem_dataset import USLGCDistributionFeaturesWithIdDataset
EPS = 1e-15

# %% 
# Load dataset
dataset = USLGCDistributionFeaturesWithIdDataset("./data/")
# examine the graph
...
#                                 input_nodes=data.train_mask)
# val_loader = NeighborLoader(data, num_neighbors=[-1] * 2, batch_size=8192, 
...
print(outdf.shape)
print(outdf[0:1])
outputfile = "./model/sage_all_label/sage_id_y_pred_51probability_test3.csv"
