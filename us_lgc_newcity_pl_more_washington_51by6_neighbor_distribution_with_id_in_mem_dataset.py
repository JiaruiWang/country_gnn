...
class USLGCNewcityPLMoreWashingtonDistributionFeaturesWithIdDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_newcity_pl_more_washington_51by6_neighbor_distribution_with_id_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_newcity_pl_more_washington_51by6_neighbor_distribution_with_id_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        us_x = self.get_node_feature('./new_city_data/new_cities_pl_label_51_by_6_neighbor_distribution.csv')
        ...
        # print(data)
        # print(slices)
        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_newcity_pl_more_washington_51by6_neighbor_distribution_with_id_in_mem_dataset.pt'))
...
# %% test the dataset 
root = "./data/"
dataset = USLGCNewcityPLMoreWashingtonDistributionFeaturesWithIdDataset(root)
print(dataset[0])
