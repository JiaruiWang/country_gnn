...
class PagenetDataset(Dataset):
    ...
    def processed_file_names(self):
        ...
        return ['page_net_s_100k_disk_node_feat_1.pt']
    ...
    def get(self, idx=None):
        data = torch.load(osp.join(self.processed_dir, f'page_net_s_100k_disk_node_feat_1.pt'))
        return data
    ...
    def process(self):
        ...
        self.data.train_mask = self.get_masks('./data/raw_dir/c_tr_s.csv')
        self.data.val_mask = self.get_masks('./data/raw_dir/c_va_s.csv')
        self.data.test_mask = self.get_masks('./data/raw_dir/c_te_s.csv')
        ...
        torch.save(self.data, osp.join(self.processed_dir, f'page_net_s_100k_disk_node_feat_1.pt'))
