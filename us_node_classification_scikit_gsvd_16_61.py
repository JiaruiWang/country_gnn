...
# %%
knn = KNN(GSVD(16), n_neighbors=61)
knn_gsvd_16_61_labels = knn.fit_transform(directed.adjacency, seeds)
# %%
print(knn_gsvd_16_61_labels.shape)
# %%
print(type(knn_gsvd_16_61_labels))
# %%
# pd.DataFrame(labels).to_csv('./data/raw_dir/us_lgc_knn_gsvd_8_20.csv')
with open('./data/raw_dir/us_lgc_knn_gsvd_16_61.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
    for r in knn_gsvd_16_61_labels:
        row = str(r.item()) 
        writer.writerow([row])
