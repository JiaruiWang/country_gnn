...
from us_lgc_newcity_truelabel_link_pred_saint_dummy_in_mem_dataset import USLGCNewcityTruelabelDummyDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelDummyDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelDummyDataset("../../data/", transform=transform)
# examine the graph
