...
from us_lgc_newcity_truelabel_link_pred_saint_all_state_pair_weights_in_mem_dataset import USLGCNewcityTruelabelAllStatePairWeightsDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelAllStatePairWeightsDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelAllStatePairWeightsDataset("../../data/", transform=transform)
# examine the graph
