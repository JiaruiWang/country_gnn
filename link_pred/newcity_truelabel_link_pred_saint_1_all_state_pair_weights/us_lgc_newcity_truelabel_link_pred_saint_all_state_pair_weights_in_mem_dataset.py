...
class USLGCNewcityTruelabelAllStatePairWeightsDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_newcity_truelabel_link_pred_saint_all_state_pair_weights_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_newcity_truelabel_link_pred_saint_all_state_pair_weights_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_newcity_truelabel_link_pred_saint_all_state_pair_weights_in_mem_dataset.pt'))
    ...
    def get_node_feature(self, file_path: str = None) -> torch.Tensor:
        ...
        weights = pd.read_csv('../truelabel_all_state_pair_weights_normalized_each_state.csv', sep=',', header=None)
...
# %% test the dataset 
root = "../../data/"
dataset = USLGCNewcityTruelabelAllStatePairWeightsDataset(root)
# %%
