...
from us_lgc_mnl_label_degree_weight_matrix_centers_in_mem_dataset import USLGCDegreeWeightMatrixCentersDataset
...
# %% 
# Load dataset
dataset_all = USLGCDegreeWeightMatrixCentersDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCDegreeWeightMatrixCentersDataset("../../data", transform=transform)
# examine the graph
...
#%%
# load model
PATH = './mnl_label_link_pred_saint_degree_weight_matrix_centers_best_0.8942549365545436.pt'
...
# %%
import csv
outputfile = './pred_label_startid_statelabel_outdegreenorm_indegreenorm_endid_statelabel_outdegreenorm_indegreenorm.csv'
with open(outputfile, 'w') as file:
    csvwriter = csv.writer(file, delimiter='\t')
    for i in range(len(total_pred)):
        row = [total_pred[i], total_edge_label[i],
               total_edge_start_id[i], total_edge_start_id_state_label[i],
               total_edge_start_degree_weights[i][0], total_edge_start_degree_weights[i][1],
               total_edge_end_id[i], total_edge_end_id_state_label[i],
               total_edge_end_degree_weights[i][0], total_edge_end_degree_weights[i][1]]
