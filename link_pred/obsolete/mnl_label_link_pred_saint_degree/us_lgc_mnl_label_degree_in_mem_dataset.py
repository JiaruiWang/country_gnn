...
class USLGCDegreeDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_mnl_label_degree_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_mnl_label_degree_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        for i in range(us_id.shape[0]):
            if us_id[i] == 305090549589266:
                print(us_id[i], us_x[i], us_y[i])

        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_mnl_label_degree_in_mem_dataset.pt'))
...
# %% test the dataset 
root = "../../data"
dataset = USLGCDegreeDataset(root)
