...
from us_lgc_mnl_label_2dummy_label_in_mem_dataset import USLGC2DummyLabelDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGC2DummyLabelDataset("../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGC2DummyLabelDataset("../data/", transform=transform)
# examine the graph
