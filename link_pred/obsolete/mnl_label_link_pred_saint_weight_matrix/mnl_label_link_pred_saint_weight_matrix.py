...
from us_lgc_mnl_label_weight_matrix_in_mem_dataset import USLGCWeightMatrixDataset
...
# %% 
# Load dataset
dataset_all = USLGCWeightMatrixDataset("../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCWeightMatrixDataset("../data/", transform=transform)
# examine the graph
