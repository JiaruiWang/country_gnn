...
# %%
# Save the model
PATH = f'./mnl_label_link_pred_saint_label_dot_sigmoid_{epoch}_{test_auc}.pt'
torch.save(net.state_dict(), PATH)
PATH = f'./mnl_label_link_pred_saint_label_dot_sigmoid_{final_test_auc_epoch}_{final_test_auc}.pt'
