...
from us_lgc_mnl_label_population_in_mem_dataset import USLGCPopulationDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGCPopulationDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCPopulationDataset("../../data/", transform=transform)
# examine the graph
...
# %%
# Save the model
PATH = f'./mnl_label_link_pred_saint_label_cat_sigmoid_{epoch}_{test_auc}.pt'
torch.save(net.state_dict(), PATH)
PATH = f'./mnl_label_link_pred_saint_label_cat_sigmoid_{final_test_auc_epoch}_{final_test_auc}.pt'
