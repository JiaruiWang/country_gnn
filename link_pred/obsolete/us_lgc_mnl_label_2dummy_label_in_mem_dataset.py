...
class USLGC2DummyLabelDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_mnl_label_2dummy_label_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_mnl_label_2dummy_label_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        # print(data)
        # print(slices)
        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_mnl_label_2dummy_label_in_mem_dataset.pt'))
...
# %% test the dataset 
root = "../data/"
dataset = USLGC2DummyLabelDataset(root)
