...
from us_lgc_mnl_label_all_edge_weight_matrix_in_mem_dataset import USLGCAllEdgeWeightMatrixCentersDataset
...
# %% 
# Load dataset
dataset_all = USLGCAllEdgeWeightMatrixCentersDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCAllEdgeWeightMatrixCentersDataset("../../data/", transform=transform)
# examine the graph
...
# %%
# Save the model
PATH = f'./mnl_label_link_pred_saint_all_edge_weight_matrix_dot_pts/test_neg_1_all_edge_weights_over_each_state/'
