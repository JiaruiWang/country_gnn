...
from us_lgc_mnl_label_out_in_degree_label_in_mem_dataset import USLGCDegreeLabelDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGCDegreeLabelDataset("../data")
print(dataset_all)
...
#%%
dataset = USLGCDegreeLabelDataset("../data/", transform=transform)
# examine the graph
