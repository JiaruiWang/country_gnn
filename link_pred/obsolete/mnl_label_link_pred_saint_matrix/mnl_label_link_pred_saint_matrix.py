...
from us_lgc_mnl_label_matrix_in_mem_dataset import USLGCMatrixDataset
...
# %% 
# Load dataset
dataset_all = USLGCMatrixDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCMatrixDataset("../../data/", transform=transform)
# examine the graph
