...
inputfile = './mnl_label_link_pred_saint_label_cat_0.8823_pred_label_startid_statelabel_endid_statelabel.csv'
...
for i in false_nega_index:
    # print(total_pred[i])
    # print(total_edge_label[i])
    # print(total_edge_start_id[i])
    # print(total_edge_end_id[i])
    # print(total_edge_start_id_state_label[i])
    # print(total_edge_end_id_state_label[i])
...
for key, edges in false_nega_dict.items():
    # print(key, len(edges))
    key_edgecount_list.append((key, len(edges)))
    edgecount_key_list.append((len(edges), key))

# %%
key_edgecount_list.sort()
# print(key_edgecount_list)
edgecount_key_list.sort(reverse=True)
# print(len(edgecount_key_list), edgecount_key_list)
# %%
inner_state_edge_count = 0
inter_state_edge_count = 0
for i in range(len(edgecount_key_list)):
    if edgecount_key_list[i][1][0] == edgecount_key_list[i][1][1]:
        inner_state_edge_count += edgecount_key_list[i][0]
    else:
        inter_state_edge_count += edgecount_key_list[i][0]
    
print(inner_state_edge_count, inter_state_edge_count)
'''
