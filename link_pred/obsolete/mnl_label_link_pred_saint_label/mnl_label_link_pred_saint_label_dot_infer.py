...
from us_lgc_mnl_label_label_in_mem_dataset import USLGCLabelDataset
...
# %% 
# Load dataset
dataset_all = USLGCLabelDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCLabelDataset("../../data/", transform=transform)
# examine the graph
...
PATH = './mnl_label_link_pred_saint_label_dot_sigmoid_50_0.9029346510551741.pt'
...
#     if total_edge_start_id[i] == 216844098354162:
#         print(total_edge_start_id[i], 
#               total_edge_start_degree_weights[i], 
#               total_edge_start_id_state_label[i])
# print(fpr)
# print(tpr)
# print(thresholds)
# %%
import csv
outputfile = './mnl_label_link_pred_saint_label_dot_0.9029_pred_label_startid_statelabel_endid_statelabel_neg1.0_epoch50.csv'
