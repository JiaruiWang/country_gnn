...
class USLGCLabelDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_mnl_label_label_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_mnl_label_label_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        # print(data)
        # print(slices)
        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_mnl_label_label_in_mem_dataset.pt'))
    ...
    def get_node_feature(self, file_path: str = None) -> torch.Tensor:
        ...
        print(one_hot_y.shape, one_hot_y)
        print(one_hot_y.dtype)
        
        x = torch.tensor(one_hot_y, dtype=torch.float32)
...
# %% test the dataset 
root = "../../data/"
dataset = USLGCLabelDataset(root)
