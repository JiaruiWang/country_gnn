...
# load model
PATH = './mnl_label_link_pred_saint_label_cat_sigmoid_150_0.882388654696602.pt'
...
# %%
import csv
outputfile = './mnl_label_link_pred_saint_label_cat_0.8823_pred_label_startid_statelabel_endid_statelabel.csv'
