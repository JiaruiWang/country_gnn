...
from us_lgc_mnl_label_2dummy_matrix_in_mem_dataset import USLGC2DummyMatrixDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGC2DummyMatrixDataset("../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGC2DummyMatrixDataset("../data/", transform=transform)
# examine the graph
