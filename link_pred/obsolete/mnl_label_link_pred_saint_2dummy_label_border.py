...
from us_lgc_mnl_label_2dummy_label_border_in_mem_dataset import USLGC2DummyLabelBorderDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGC2DummyLabelBorderDataset("../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGC2DummyLabelBorderDataset("../data/", transform=transform)
# examine the graph
