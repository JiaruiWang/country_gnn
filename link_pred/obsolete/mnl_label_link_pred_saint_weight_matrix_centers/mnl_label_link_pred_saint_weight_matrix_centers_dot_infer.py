...
transform = T.Compose([
    ...
    # T.ToDevice(device),
    T.RandomLinkSplit(num_val=0.001, num_test=0.01, is_undirected=False,
...
print(dataset_all, dataset_all[0])
...
PATH = './mnl_label_link_pred_saint_weight_matrix_centers_dot_sigmoid_7_0.908737357588839.pt'
...
# %%
import csv
outputfile = './mnl_label_link_pred_saint_weight_matrix_centers_dot_0.9087_pred_label_startid_statelabel_endid_statelabel_neg1.0_test0.01.csv'
