...
from us_lgc_mnl_label_2dummy_in_mem_dataset import USLGC2DummyDataset
EPS = 1e-15
#%%
# define link split
...
# %% 
# Load dataset
dataset_all = USLGC2DummyDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGC2DummyDataset("../../data/", transform=transform)
# examine the graph
...
#%%
# Save the model
PATH = f'./mnl_label_link_pred_saint_2dummy_cat_pts/1/'
for i in range(len(loss_list)):
    file = PATH + f'epoch_{i+1:03d}_loss_{loss_list[i]:.4f}_testauc_{test_auc_list[i]:.4f}.pt'
    print(file)
