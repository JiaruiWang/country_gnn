...
from us_lgc_newcity_truelabel_link_pred_saint_label_border_state_pair_weights_in_mem_dataset import USLGCNewcityTruelabelLableBorderStatePairWeightsDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelLableBorderStatePairWeightsDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelLableBorderStatePairWeightsDataset("../../data/", transform=transform)
# examine the graph
