...
from us_lgc_newcity_truelabel_link_pred_saint_label_in_mem_dataset import USLGCNewcityTruelabelLableDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelLableDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelLableDataset("../../data/", transform=transform)
# examine the graph
