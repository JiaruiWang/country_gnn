...
from us_lgc_newcity_truelabel_link_pred_saint_degree_in_mem_dataset import USLGCNewcityTruelabelDegreeDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelDegreeDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelDegreeDataset("../../data/", transform=transform)
# examine the graph
