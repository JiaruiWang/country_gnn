...
from us_lgc_newcity_truelabel_link_pred_saint_population_in_mem_dataset import USLGCNewcityTruelabelPopulationDataset
...
# %% 
# Load dataset
dataset_all = USLGCNewcityTruelabelPopulationDataset("../../data")
print(dataset_all)
print(type(dataset_all))

#%%
dataset = USLGCNewcityTruelabelPopulationDataset("../../data/", transform=transform)
# examine the graph
