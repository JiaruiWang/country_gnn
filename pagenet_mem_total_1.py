...
class PagenetDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data, self.slices = torch.load(osp.join(self.processed_dir, f'page_net_total_memory_node_feat_1.pt'))
    ...
    def processed_file_names(self):
        ...
        return ['page_net_total_memory_node_feat_1.pt']
    ...
    def process(self):
        ...
        dataset.train_mask = self.get_masks('./data/raw_dir/c_tr.csv')
        dataset.val_mask = self.get_masks('./data/raw_dir/c_va.csv')
        dataset.test_mask = self.get_masks('./data/raw_dir/c_te.csv')
        ...
        print(data)
        print(slices)
        torch.save((data, slices), osp.join(self.processed_dir, f'page_net_total_memory_node_feat_1.pt'))
