...
from us_lgc_truelabel_features_in_mem_dataset import USLGCTrueLabelFeaturesDataset
EPS = 1e-15

# %% 
# Load dataset
dataset = USLGCTrueLabelFeaturesDataset("./data/")
# examine the graph
...
train_loader = NeighborLoader(data, num_neighbors=[-1] * 2, batch_size=1865787,
                                input_nodes=data.train_mask,
                                sampler=sampler)
val_loader = NeighborLoader(data, num_neighbors=[-1] * 2, batch_size=233000, 
                                input_nodes=data.val_mask)
test_loader = NeighborLoader(data, num_neighbors=[-1] * 2, batch_size=233000,
