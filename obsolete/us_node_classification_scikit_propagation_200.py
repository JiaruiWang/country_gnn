...
# %%
propagation = Propagation(n_iter=200)
propagation_200_labels = propagation.fit_transform(directed.adjacency, seeds)
# %%
print(propagation_200_labels.shape)
# %%
print(type(propagation_200_labels))
# %%
# pd.DataFrame(labels).to_csv('./data/raw_dir/us_lgc_knn_gsvd_8_20.csv')
with open('./data/raw_dir/us_lgc_propagation_200_.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
    for r in propagation_200_labels:
        row = str(r.item()) 
        writer.writerow([row])
