...
# %%
propagation = Propagation(n_iter=50)
propagation_50_labels = propagation.fit_transform(directed.adjacency, seeds)
# %%
print(propagation_50_labels.shape)
# %%
print(type(propagation_50_labels))
# %%
# pd.DataFrame(labels).to_csv('./data/raw_dir/us_lgc_knn_gsvd_8_20.csv')
with open('./data/raw_dir/us_lgc_propagation_50_.csv', 'w') as csvfile:
    writer = csv.writer(csvfile)
    for r in propagation_50_labels:
        row = str(r.item()) 
        writer.writerow([row])
