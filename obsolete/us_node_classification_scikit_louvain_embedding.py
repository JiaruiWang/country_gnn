...
louvain_32_embedding = louvain.fit_transform(directed.adjacency)
# %%
# %%
print(louvain_32_embedding.shape)
# %%
print(type(louvain_32_embedding))
# %%
# pd.DataFrame(labels).to_csv('./data/raw_dir/us_lgc_knn_gsvd_8_20.csv')
np.savetxt(fname='./data/raw_dir/us_lgc_louvain_32_embedding.csv', 
           X=louvain_32_embedding,
           delimiter='\t') 
