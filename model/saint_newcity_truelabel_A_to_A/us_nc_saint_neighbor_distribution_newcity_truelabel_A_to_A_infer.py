...
print(f'Number of labeled_mask nodes: {data.labeled_mask.sum()}')
...
#%%
subgraph_edge_index, subgraph_edge_weight = subgraph(data.labeled_mask, data.edge_index, data.edge_weight, relabel_nodes=True)
# print(subgraph_edge_index.shape, subgraph_edge_weight.shape)
subgraph_x = data.x[data.labeled_mask]
subgraph_y = data.y[data.labeled_mask]
...
file = PATH + 'best_auc_epoch_142_loss_36.8658_testauc_0.8743.pt'
...
# %%
filename = './saint_newcity_truelabel_A_to_A_infer_A_id_y_pred_51probability.csv'
...
#%%
filename = './saint_newcity_truelabel_A_to_A_infer_AB_id_y_pred_51probability.csv'
