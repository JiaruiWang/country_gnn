...
pl_class_names = ["AL", "AK", "AZ", "AR", "CA", "CO", "CT",\
                  ...
                  "WY", "DC"]
pl_state_names = ["Alabama","Alaska","Arizona","Arkansas","California","Colorado","Connecticut",
...
file = './saint_newcity_truelabel_A_to_A_infer_AB_id_y_pred_51probability.csv'
...
softmax_probability = log_softmax(scores, axis=1)
...
#%%
outputfile = './log_softmax_id_label_state_pred_state_threshold_counts_possible_states.csv'
...
#%%
iter = 100
inputfile = './log_softmax_id_label_state_pred_state_threshold_counts_possible_states.csv'
