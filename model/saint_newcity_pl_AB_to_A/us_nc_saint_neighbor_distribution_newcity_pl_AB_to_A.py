...
file = PATH + 'epoch_224_loss_19.3169_testauc_0.8590.pt'
...
file = PATH + f'best_auc_epoch_{max_index + start:03d}_loss_{loss_list[max_index]:.4f}_testauc_{test_auc_list[max_index]:.4f}.pt'
print(file)
