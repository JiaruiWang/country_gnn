...
pl_path = './saint_newcity_truelabel_A_to_A_no_6_centers_45_infer_A_id_y_pred_45probability.csv'
...
np.savetxt('truelabel_no_6_centers_cm_2d.csv', cnf_matrix, fmt='%2d', delimiter=',')
