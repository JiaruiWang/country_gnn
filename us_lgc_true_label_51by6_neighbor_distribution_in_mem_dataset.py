...
class USLGCDistributionFeaturesTrueLabelDataset(InMemoryDataset):
    def __init__(self, root, transform=None, pre_transform=None, pre_filter=None):
        ...
        self.data = torch.load(osp.join(self.processed_dir, f'us_lgc_true_label_51by6_neighbor_distribution_in_mem_dataset.pt'))
    @property
    ...
    def processed_file_names(self):
        ...
        return ['us_lgc_true_label_51by6_neighbor_distribution_in_mem_dataset.pt']
    ...
    def process(self):
        ...
        us_y, self.mask = self.get_y_label('./data/raw_dir/us_pages_lgc_true_label_51_label.csv')
        ...
        # print(data)
        # print(slices)
        torch.save(self.data, osp.join(self.processed_dir, f'us_lgc_true_label_51by6_neighbor_distribution_in_mem_dataset.pt'))
